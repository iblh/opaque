...
module.exports = {
  ...
  content: [
    ...
    // lib/layouts.ts declares the bento tile spans as literal class strings, so
    // the scanner has to see it too — otherwise those classes silently vanish.
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        body: ['var(--font-sans)', 'ui-sans-serif', 'system-ui', '-apple-system', 'BlinkMacSystemFont', "Segoe UI", 'Roboto', "Helvetica Neue", 'Arial', "Noto Sans", 'sans-serif'],
